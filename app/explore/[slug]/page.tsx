            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-24 gap-y-6 py-6 mb-6 md:w-[80%]">
              ...
              {project.projectType && (
                <div style={{ maxWidth: "400px" }}>
                  ...
                  <p className="text-[13px] leading-relaxed">{project.projectType}</p>
                </div>
              )}
              <div style={{ maxWidth: "400px" }}>
              ...
              {project.mentors && project.mentors.length > 0 && (
                <div style={{ maxWidth: "400px" }}>
                  ...
                  <p className="text-[13px] leading-relaxed">{project.mentors.join(", ")}</p>
                </div>
              )}
              {project.achievement && (
                <div style={{ maxWidth: "400px" }}>
                  <p className="text-[10px] uppercase tracking-widest text-foreground/40 mb-2">Achievement</p>
                  <p className="text-[13px] leading-relaxed">{project.achievement}</p>
                </div>
              )}
              <div style={{ maxWidth: "400px" }}>
